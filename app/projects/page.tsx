...
const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            'Turns large-scale JSON datasets into interactive Leaflet maps and analytics dashboards that upper management actually uses to make decisions. Please note: screen recording may introduce some lag or artifacts.',
    ...
    },
    {
        ...
        tags: ['Python', 'AI', 'Minimax', 'WebAssembly'],
